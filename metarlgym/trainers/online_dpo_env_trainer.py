...
• Collects (prompt, chosen, rejected) triples online from a `metarlgym` Environment.
...
class AlphaOnlineDPOEnvTrainer(DPOTrainer):
    ...
    :class:`metarlgym.envs.environment.Environment`.
...
if __name__ == "__main__":
    ...
    from metarlgym.envs.dummy_env import DummyEnv  # fictional example
