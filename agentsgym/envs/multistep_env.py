...
class MultistepEnv(Environment):
    ...
    def __init__(
        ...
        # AS: Why do we need system_prompt in __init__? It can be handled inside each env, and some env don't need system prompt.
        system_prompt: str = "",
        # AS: This is equivalent to max_turns in State in TA, is this necessary?
    ...
    def run_trial(
        ...
        **kwargs: Any
        ...
        # AS: It should always only return trajectories, why do I need it to return tracking information?
        ...
        # Process each prompt
        # AS: No more should i be prompt, it should be task_dict?
        ...
        for idx, session_id in enumerate(session_ids):
            ...
            # AS: It shouldn't only be final_ep that has rewards, the whole trial's reward should be included.
            final_ep = episodes[-1]
